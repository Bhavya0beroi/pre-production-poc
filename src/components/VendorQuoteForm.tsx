...
export function VendorQuoteForm({ shoot, relatedShoots = [], onSubmit, onBack, isStandalone = false }: VendorQuoteFormProps) {
  ...
  const whatsappMessage = encodeURIComponent(
    ...
    (isMultiShoot 
      ? allShoots.map((s, i) => `${i + 1}. ${s.name} (${s.date})`).join('\n')
          ...
          <div className="px-6 py-3 border-b border-gray-200 bg-yellow-50 flex-shrink-0">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="px-3 py-2 rounded-lg transition-colors flex items-center gap-1 flex-shrink-0 text-sm font-medium"
                style={{ 
              ...
              <a
                ...
                className="px-3 py-2 rounded-lg text-white flex items-center gap-1 text-sm font-medium"
